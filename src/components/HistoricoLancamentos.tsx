  ...
  const fetchHistorico = async () => {
    ...
    try {
      ...
      if (!scriptUrl) {
        // Mock data
        setLancamentos([
          { id: 1, data: '10/04/2024', tipo: 'Custeio', membro: 'João Silva', rubrica: 'Material de Consumo', valor: 1500, comprovante: 'Sim' },
          { id: 2, data: '08/04/2024', tipo: 'Custeio', membro: 'Maria Souza', rubrica: 'Diárias', valor: 760, comprovante: 'Sim' },
          { id: 3, data: '05/04/2024', tipo: 'Custeio', membro: 'Carlos Mendes', rubrica: 'Serviços de Terceiros', valor: 5000, comprovante: 'Não' },
          { id: 4, data: '02/04/2024', tipo: 'Bolsa', membro: 'Ana Costa', rubrica: 'Bolsa DTI-C', valor: 800, comprovante: '-' },
        ]);
        setLoading(false);
        return;
      }
