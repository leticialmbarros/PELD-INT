    ...
    const fetchMetas = async () => {
      try {
        ...
        if (!scriptUrl) {
          // Mock data
          setMetas([
            { id: 1, nome: 'Etapa 1 - Reunião Inicial', status: 'Concluída', progresso: 100, grupo: 'Geral' },
            { id: 2, nome: 'Etapa 2 - Compra de Equipamentos', status: 'Em Andamento', progresso: 60, grupo: 'Vertebrados' },
            { id: 3, nome: 'Etapa 3 - Coleta de Amostras', status: 'Atrasada', progresso: 30, grupo: 'DNA Ambiental' },
            { id: 4, nome: 'Etapa 4 - Análise de Dados', status: 'Em Andamento', progresso: 10, grupo: 'Plantas' },
            { id: 5, nome: 'Etapa 5 - Relatório Parcial', status: 'Atrasada', progresso: 0, grupo: 'Geral' },
            { id: 6, nome: 'Etapa 6 - Publicação de Artigo', status: 'Em Andamento', progresso: 50, grupo: 'Artrópodes' },
          ]);
          setLoading(false);
          return;
        }
