export async function saveToGoogleSheets(data: any): Promise<{ success: boolean; message?: string; error?: string }> {
  try {
    ...
    const scriptUrl = import.meta.env.VITE_GOOGLE_SCRIPT_URL || 'https://script.google.com/macros/s/AKfycbwTwsf2Ou6lvaCL5b7JA5_hrHYOpvy2Yo0UkZnXajhUIWSixyPjFpayyr7MuKkwHI1-bg/exec';
